# 用实体实验法学Web前端开发 (Learn Web Frontend Development The Physical Way)
...
- **UI's Grammar: Javascript XML(JSX)**
	...
	- [使用key值识别Virtual DOM的节点](/chapters/React/UIs-Grammar-Javascript-XML(JSX)/使用key值识别Virtual DOM的节点.md)
